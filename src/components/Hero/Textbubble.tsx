  ...
  return (
    ...
    >
      <motion.div
        ...
        className="sm chat-bubble max-w-lg bg-slate-800 text-lg font-light text-slate-100 before:h-4 before:w-4 before:-translate-x-px md:text-[clamp(0.875rem,0.3242rem+1.1475vw,1.4rem);] short:text-base"
        transition={{
          layout: {
            duration: 1.2,
            ease,
